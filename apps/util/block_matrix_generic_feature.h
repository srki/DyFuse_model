...
GrB_Info create_blocks_feature_##_name(GrB_Matrix **bA_out, GrB_Matrix A, size_t nrows_blocked, size_t ncols_blocked,   \
                                size_t nrows_block, size_t ncols_block, bool full_idxes, double* features) {                      \
    /* Input matrix tuples */                                                                                   \
    GrB_Index *I, *J;                                                                                           \
    _type *X;                                                                                                   \
                                                                                                                \
...
GrB_Info create_blocks_feature_g(GrB_Matrix **bA_out, GrB_Matrix A, GrB_Index nrows_blocked, GrB_Index ncols_blocked,
                         size_t nrows_block, size_t ncols_block, bool full_idxes, GrB_Type type,double* features) {
    if (type == GrB_UINT64) {
        return create_blocks_feature_uint64(bA_out, A, nrows_blocked, ncols_blocked, nrows_block, ncols_block, full_idxes, features);
    } else if (type == GrB_FP64) {
        return create_blocks_feature_double(bA_out, A, nrows_blocked, ncols_blocked, nrows_block, ncols_block, full_idxes,features);
    } else {
